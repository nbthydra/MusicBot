module.exports = {
  Admins: ["945516946164690954", "945516946164690954"], // Admins of the bot, I don't know what this do. -Darren.
  ExpressServer: true, // If you wanted to make the website run or not
  DefaultPrefix: process.env.Prefix || ">", // Default prefix, Server Admins can change the prefix
  Port: 3000, //Which port website gonna be hosted
  SupportServer: "https://discord.gg/tkrp", // Support Server Link
  Token: process.env.Token || "MTA5MTYxMzgwNTg3MzczMzY0NA.GUw-gQ.6h7iA9P1Zg-luqk6LacUWblkxNQc7e5CVOF74k", // Discord Bot Token
  ClientID: process.env.Discord_ClientID || "1091613805873733644", // Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || "HjaqkJkLCcP-IsKKlRVxg9EYZrikL2-Y", // Discord Client Secret
  ...
  Presence: {
    ...
    name: "Pikachu", // The message shown
  ...
  Spotify: {
    ClientID: process.env.Spotify_ClientID || "44b9d63c753b4a6cb571dc6c89d7f42b", // Spotify Client ID
    ClientSecret: process.env.Spotify_ClientSecret || "f8ca629eabc047a1834aa9c1151571d2", // Spotify Client Secret
  },
};
